    ...
    return (
        <main className="min-h-screen bg-white py-24">
            <div className="mx-auto max-w-5xl px-6 text-center">
                <h1 className="mb-6 text-4xl font-bold text-gray-900">Moving Abroad</h1>
                <p className="mx-auto mb-8 max-w-3xl text-lg text-gray-700">
                    Planning to relocate from Nigeria? Setudown helps you prepare, relocate and settle with confidence — from pre-departure planning to your first weeks abroad.
                </p>
